        ...
        <form onSubmit={handleEmailLogin} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              disabled={submitting}
              className="w-full px-3 py-2 bg-white text-gray-900 placeholder:text-gray-400 border border-gray-300 rounded-lg text-sm caret-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:opacity-50"
            />
          </div>
